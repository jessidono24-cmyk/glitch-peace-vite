...
export const TILE_DEF = {
  ...
  [T.HOPELESS]: { d: 0,  s: 1, p: 0, bg: '#002040', bd: '#0044cc', g: '#0066ff', sy: '~', solid: false, emo: ['despair','loneliness'] },
  ...
  [T.TRAP]:     { d: 0,  s: 0, p: 0, bg: '#1a0800', bd: '#cc6600', g: '#ff8800', sy: '×', solid: false, emo: ['anxiety'] },
