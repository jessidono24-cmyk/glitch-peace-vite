...
// Merged from glitch-peace-v5 + base layer utilities
// ═══════════════════════════════════════════════════════════════════════
...
export const dist = (y1, x1, y2, x2) => Math.abs(y2 - y1) + Math.abs(x2 - x1); // Manhattan
...
// ─── PATHFINDING (Simple A* for enemy AI) ──────────────────────────────
