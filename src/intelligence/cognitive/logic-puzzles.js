...
export class LogicPuzzles {
  ...
  get challengeAlpha() {
    ...
    if (t > CHALLENGE_HOLD + CHALLENGE_FADE_OUT) {
      return (CHALLENGE_TOTAL - t) / CHALLENGE_FADE_IN;            // fade in
    }
    if (t < CHALLENGE_FADE_OUT) return t / CHALLENGE_FADE_OUT;    // fade out
    return 1;
  }
