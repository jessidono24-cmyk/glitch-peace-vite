...
const SESSION_MILESTONES = [
  { minutes: 20, message: "You've played 20 minutes · Take a breath 🌬", color: '#88ddff' },
  { minutes: 45, message: '45 minutes played · Rest your eyes for a moment 👁', color: '#ffcc88' },
  { minutes: 90, message: '90 minutes · Consider a real break 🌿', color: '#ff8888' },
];
